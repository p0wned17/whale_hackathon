...
class ArcModule(nn.Module):
    ...
    def forward(self, inputs, labels):
        ...
        cos_th_m = torch.where(cos_th > self.th, cos_th_m, cos_th - self.mm).to(
            torch.float32
        )
...
class WhalesNet(nn.Module):
    def __init__(
        ...
        self.fc1 = nn.Linear(self.in_features * 100, self.channel_size)  # 576 49
    ...
    def forward(self, x, labels=None):
        ...
        # print("features shape13323232323", features.shape)
